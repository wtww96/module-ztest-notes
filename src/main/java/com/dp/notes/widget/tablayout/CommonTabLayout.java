...
import com.dp.notes.widget.tablayout.listener.CustomTabEntity;
import com.dp.notes.widget.tablayout.listener.OnTabSelectListener;
import com.dp.notes.widget.tablayout.utils.FragmentChangeManager;
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (mIconGravity == Gravity.LEFT) {
                tabView = View.inflate(mContext, R.layout.notes_layout_tab_left, null);
            } else if (mIconGravity == Gravity.RIGHT) {
                tabView = View.inflate(mContext, R.layout.notes_layout_tab_right, null);
            } else if (mIconGravity == Gravity.BOTTOM) {
                tabView = View.inflate(mContext, R.layout.notes_layout_tab_bottom, null);
            } else {
                tabView = View.inflate(mContext, R.layout.notes_layout_tab_top, null);
            }
