...
class StateFragment : BaseFragment(R.layout.notes_fragment_child) {
    ...
    private val state by lazy { StateView.inject(this) }
    ...
    override fun initListener() {
        //点击重试
        state.onRetryClickListener = object : StateView.OnRetryClickListener {
    ...
    companion object {
        fun newInstance(type: String) = StateFragment().apply {
